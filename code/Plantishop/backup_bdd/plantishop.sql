...
--
-- Client :  localhost
-- Généré le :  Lun 04 Janvier 2021 à 22:59
...
(6, 'Plante', 'Palmier nain', 24.99, 'Placé dans le jardin ou sur une terrasse, le palmier nain constitue un arbuste de décoration très appréciable. L\'association avec une plante tropicale est aussi intéressante.', 10),
(7, 'Graine', 'Graines de cerisier', 4.99, 'Arbre arrondi se couvrant, en fin d\'hiver tout début du printemps, de fleurs en coupe, blanches, sur des rameaux nus en même temps que les feuilles. Il produit de petits fruits rouges ou jaunes, comestibles à l\'aspect de prunes.', 10);
...
CREATE TABLE `utilisateur` (
  ...
  `num_cb` varchar(16) DEFAULT NULL,
  `nom_cb` varchar(100) DEFAULT NULL,
  `num_cvv` varchar(3) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(1, 'admin', 'tom', 'pass', 'tom@gmail.com', '45674897912', 'adresse facturation', 'adresse livraison', '4487544067211533', 'Nom CB', '123'),
(2, 'admin', 'antoine', 'pass', 'antoine@gmail.com', '06-23-43-65-21', NULL, NULL, NULL, NULL, NULL);
